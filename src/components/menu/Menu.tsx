    ...
    return (
        ...
        <div className=" fade-element text-7xl md:text-7xl  lg:text-9xl" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <ul>
                ...
                <li onClick={handleWorkClick} className="hover:animate-pulse" style={{ color: "#1f458c", fontFamily: "Bold", cursor: "pointer" }}><a style={{ fontFamily: "Bold" }} className=" fade-element text-2xl text-black md:text-3xl  lg:text-3xl">3.</a>W<a style={{ color: "#11254c", fontFamily: "Kilogram" }}>ORK</a></li>
